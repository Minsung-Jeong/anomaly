...
criteria = math.trunc((train['rankPoints'].max() - train['rankPoints'].min()) / 5)

# split rankPoints into 5 levels
# temp = []
# for i in range(len(train)):
#     if train['rankPoints'][i] < criteria:
#         temp.append(1)
#     elif criteria <= train['rankPoints'][i] < criteria * 2:
#         temp.append(2)
#     elif criteria * 2 <= train['rankPoints'][i] < criteria * 3:
#         temp.append(3)
#     elif criteria * 3 <= train['rankPoints'][i] < criteria * 4:
#         temp.append(4)
#     elif criteria * 4 <= train['rankPoints'][i]:
#         temp.append(5)

train['rankLevel'] = temp
