...
input = pd.read_csv("C://data_minsung/finance/trade/cpng_trade.csv").iloc[::-1]
...
print(np.sum(result)+account_rev, trade)


table = pd.concat((a,b, account_with_date), axis=1)
# table.to_csv("C://data_minsung/finance/trade/result/cpng_2022.csv")
